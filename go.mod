...
require (
	...
	github.com/esilver/duckdb-go-pure v0.3.11 // indirect
...
replace github.com/goccy/googlesqlite => github.com/esilver/googlesqlite v0.0.0-20260612221932-17eac0833952
