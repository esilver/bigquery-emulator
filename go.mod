...
require (
	...
	github.com/esilver/duckdb-go-pure v0.3.13 // indirect
...
replace github.com/goccy/googlesqlite => github.com/esilver/googlesqlite v0.0.0-20260613062432-da4748d5240d
