...
require (
	...
	github.com/goccy/googlesqlite v0.2.3
...
require (
	...
	github.com/esilver/duckdb-go-pure v0.3.8 // indirect
...
replace github.com/goccy/googlesqlite => github.com/esilver/googlesqlite v0.2.30-pure-go
